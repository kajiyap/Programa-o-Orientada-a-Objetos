...
import ListagemProd from "../negocio/Consumidos/listagemProdCons";
import ListagemConsPet from "../negocio/Consumidos/listagemConsPet";
        ...
        case 7:
            ...
            switch(oitavaEscolha){
                ...
                case 2: 
                    ...
                    break;
                case 3:
                    let listaProd = new ListagemProd (empresa.getProdutos, empresa.getServicos)
                    listaProd.listar()
                    break;
                case 4:
