...
import ElementoProdServ from "./elementoListaProdServ";

interface ListaProdServProps {
    tema: string;
}

class ListaProdServ extends Component<ListaProdServProps> {
    render() {
        const { tema } = this.props;
        const style: React.CSSProperties | undefined = { display: "flex", flexDirection: "row", margin: "0.5vh", paddingRight: "20vh", fontSize: "3vh" };
                ...
                <div className="row" style={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
                    <div className="col">
                        <div style={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
                            <h2>Produtos</h2> 
                            <CadastrarProdServ tema={tema} nome="Produto" />
                        </div>
                    ...
                    <div className="col">
                        <div style={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
                            <h2>Serviços</h2> 
                            <CadastrarProdServ tema={tema} nome="Serviço" />
                        </div>
                        <div className="list-group list-group-flush" style={style}>
                            <a href="#" className="list-group-item list-group-item-action" aria-expanded="false">Consumo</a>
                            <a href="#" className="list-group-item list-group-item-action" aria-expanded="false">Nome</a>
