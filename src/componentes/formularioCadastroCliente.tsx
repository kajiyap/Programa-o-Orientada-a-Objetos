...
export default class FormularioCadastroCliente extends Component<props> {
    ...
    render() {
        ...
        return (
            ...
            <button style={{margin: "2vh"}} className="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="collapse" data-bs-target="#collapseCliente" aria-expanded="false" aria-controls="collapseCliente">
                Cadastro de cliente
            </button>
            <button style={{margin: "2vh"}} className="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTel" aria-expanded="false" aria-controls="collapseTel">
                Cadastro de telefone
            </button>
            <button style={{margin: "2vh"}} className="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="collapse" data-bs-target="#collapseRg" aria-expanded="false" aria-controls="collapseRg">
                Cadastro de RG
            </button>
            <div className="row">
                <div className="col">
                    <div className="collapse" id="collapseCliente">
                ...
                <div className="col">
                    <div className="collapse" id="collapseTel">
                        <form style={{background: tema, padding: "3vh", borderRadius: "3vh",margin:"1vh", alignSelf: "flex-end"}}>
                            <h5>Cadastro de telefone</h5>
                            <div className="dropdown" style={{margin:"1vh"}}>
                                <button className="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Selecione o cliente                        
                                </button>
                                <ul className="dropdown-menu">
                                    <li><a className="dropdown-item" href="#">Pedro</a></li>
                                    <li><a className="dropdown-item" href="#">Matheus</a></li>
                                    <li><a className="dropdown-item" href="#">Bruno</a></li>
                                    <li><a className="dropdown-item" href="#">Cauã</a></li>
                                    <li><a className="dropdown-item" href="#">Erick</a></li>
                                </ul>
                            </div>
                            <div className="input-group mb-3">
                    ...
                    <div className="collapse" id="collapseRg">
                        <form style={{background: tema, padding: "3vh", borderRadius: "3vh", margin:"1vh", alignSelf: "flex-end"}}>
