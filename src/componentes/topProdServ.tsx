...
import ElementoTopProdServ from "./elementoListagemProdServ";

interface TopProdServProps {
    tema: string;
}

const TopProdServ: React.FC<TopProdServProps> = ({ tema }) => {
    return (
