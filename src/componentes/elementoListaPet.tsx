...
interface ElementoListaPetProps {
    dono: string;
    nome: string;
    raca: string;
    tipo: string;
...
class ElementoListaPet extends Component<ElementoListaPetProps> {
    render() {
        const { dono, nome, raca, tipo, genero } = this.props;
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">Atualização de Pet</h5>
...
export default ElementoListaPet;
